  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-md px-6">
        ...
        <h2 className="text-lg font-heading font-bold text-surface-900 mb-2">Erreur</h2>
        <p className="text-sm text-surface-500 mb-6">{error.message || 'Impossible de charger cette page.'}</p>
