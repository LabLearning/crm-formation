    ...
    <>
      <section className="relative overflow-hidden max-w-6xl mx-auto px-5 md:px-8 pt-16 md:pt-28 pb-10">
        ...
        <h1 className="ll-display ll-fluid-hero text-[#14110F] text-balance">
          Des <span className="text-[#195144]">enseignes de la restauration</span> nous confient leurs équipes.
        </h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
          {ENSEIGNES.map((nom, i) => (
            <Reveal key={nom} delay={(i % 4) * 70}>
              <div className="h-24 rounded-2xl border border-[#195144]/10 bg-white flex items-center justify-center px-4 text-center hover:border-[#195144]/25 hover:shadow-sm ll-lift">
