...
export async function updateOrganizationAction(formData: FormData): Promise<ActionResult> {
  ...
  const updates = {
    ...
    affacturage_actif: formData.get('affacturage_actif') === 'on',
    affacturage_societe: get('affacturage_societe'),
    affacturage_compte: get('affacturage_compte'),
    affacturage_iban: get('affacturage_iban'),
    affacturage_bic: get('affacturage_bic'),
    affacturage_mention: get('affacturage_mention'),
