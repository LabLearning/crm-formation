                    ...
                    <td className="px-4 py-2">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button onClick={() => setOpen({ apprenantId: aid, nom: c.nom, semaine: null })}
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-colors ${fin ? (fin.statut === 'validee' ? 'bg-emerald-50 text-emerald-700 hover:bg-emerald-100' : 'bg-amber-50 text-amber-700 hover:bg-amber-100') : 'bg-surface-100 text-surface-600 hover:bg-surface-200'}`}>
