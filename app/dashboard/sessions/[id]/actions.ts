...
export async function updateSessionStatusAction(sessionId: string, newStatus: string, coutFormateur?: number | null): Promise<ActionResult> {
  ...
  if (newStatus === 'terminee') {
    try { await envoyerHygieneAutomatique(supabase, sessionId, session.organization.id) }
...
async function envoyerHygieneAutomatique(supabase: any, sessionId: string, orgId: string) {
